...
namespace natix
{
	...
	public class NumericUInt32 : INumeric<UInt32>
	{
		...
		public double SimCos(IList<UInt32> a, IList<UInt32> b) {
	   ...
	   public double Sum(IList<UInt32> a)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double Mean(IList<UInt32> a)
	   {
	   		return this.Sum(a) / a.Count;
	   }
	   
	   public double Max(IList<UInt32> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Min(IList<UInt32> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Var(IList<UInt32> a, double mean)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double StdDev(IList<UInt32> a, double mean)
	   {
