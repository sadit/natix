...
namespace natix
{
	...
	public class NumericInt64 : INumeric<Int64>
	{
		...
		public double SimCos(IList<Int64> a, IList<Int64> b) {
	   ...
	   public double Sum(IList<Int64> a)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double Mean(IList<Int64> a)
	   {
	   		return this.Sum(a) / a.Count;
	   }
	   
	   public double Max(IList<Int64> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Min(IList<Int64> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Var(IList<Int64> a, double mean)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double StdDev(IList<Int64> a, double mean)
	   {
