...
namespace natix
{
	...
	public class NumericInt32 : INumeric<Int32>
	{
		...
		public double SimCos(IList<Int32> a, IList<Int32> b) {
	   ...
	   public double Sum(IList<Int32> a)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double Mean(IList<Int32> a)
	   {
	   		return this.Sum(a) / a.Count;
	   }
	   
	   public double Max(IList<Int32> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Min(IList<Int32> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Var(IList<Int32> a, double mean)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double StdDev(IList<Int32> a, double mean)
	   {
