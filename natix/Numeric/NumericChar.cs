...
namespace natix
{
	...
	public class NumericChar : INumeric<Char>
	{
		...
		public double SimCos(IList<Char> a, IList<Char> b) {
	   ...
	   public double Sum(IList<Char> a)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double Mean(IList<Char> a)
	   {
	   		return this.Sum(a) / a.Count;
	   }
	   
	   public double Max(IList<Char> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Min(IList<Char> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Var(IList<Char> a, double mean)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double StdDev(IList<Char> a, double mean)
	   {
