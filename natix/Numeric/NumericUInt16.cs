...
namespace natix
{
	...
	public class NumericUInt16 : INumeric<UInt16>
	{
		...
		public double SimCos(IList<UInt16> a, IList<UInt16> b) {
	   ...
	   public double Sum(IList<UInt16> a)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double Mean(IList<UInt16> a)
	   {
	   		return this.Sum(a) / a.Count;
	   }
	   
	   public double Max(IList<UInt16> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Min(IList<UInt16> a, out int pos)
	   {
	   		var len = a.Count;
	   		double s = a[0];
	   		pos = 0;
	   ...
	   public double Var(IList<UInt16> a, double mean)
	   {
	   		var len = a.Count;
	   		double s = 0;
	    	for (int i = 0; i < len; ++i) {
	   ...
	   public double StdDev(IList<UInt16> a, double mean)
	   {
