...
//
//   Original filename: natix/CompactDS/Lists/Unsorted/ListSDiff.cs
// 
using System;
...
{
	public class ListSDiff : ListGenerator<int>, ILoadSave
	{
		...
		public void Load (BinaryReader Input)
		{
			...
			this.Offsets = ListIGenericIO.Load(Input);
		}
		...
		public void Save (BinaryWriter Output)
		{
			...
			ListIGenericIO.Save (Output, this.Offsets);
		}
