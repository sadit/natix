...
//{
//	public class PolyIndexLC : BasicIndex, IndexSingle
//	{
...
//        }
//        
//        public bool MustReviewItem (int item, double radius, object ctx)
//        {
//            var ctx_list = (ctx as ArrayList);
//            for (int i = 0; i < this.LC_LIST.Count; ++i) {
//                var lc = this.LC_LIST[i];
//                var ctx_lc = ctx_list[i];
//                var review = lc.MustReviewItem(item, radius, ctx_lc);
//                if (!review) {
//                    return false;
//                }
//            }
