...
{
    public class PolyIndexLC_ApproxGraphEager : PolyIndexLC
    {
        public int RepeatTimes;
        public int FailTimes;

        public PolyIndexLC_ApproxGraphEager () : this(5, 5)
        {
        }

        public PolyIndexLC_ApproxGraphEager (int repeat, int failtimes) : base()
        {
                ...
                while (true) {
                    ...
                    for (int rank = 1; rank <= count1; ++rank) {
                        ...
                        if (! C [pos]) {
                            ...
                            //**** MAIN DIFFERENCE: follow a closer link eagerly
                            if (res_inner.Count > 0 && res_inner.First.dist > d) {
                                rank = 1 + count1; // skipping the rest of the bucket
                            }
