...
//{
//	public class SmallPerm : BasicIndex
//	{
//		public class Perm
//		{
//			public byte[] perm;
...
//
//		public int[] REFS;
//        public Dictionary<Perm, IList<int>> TABLE;
//
//		public override string ToString ()
//		{
//			return string.Format ("[SmallPerms K: {0}, num_refs: {1}, num_symbols: {2}, db: {3}]",
